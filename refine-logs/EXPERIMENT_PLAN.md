...
**Current status:** every frozen pool is complete at its exact preregistered successful count and contains PF-mode outputs; the internal OPF solve is used only to choose generator setpoints. The full audit passed in job 55081, target and split freezes passed in jobs 55087–55088, and split materialization passed in job 55089. All-topology geometry jobs 55090, 55100, and 55114 failed closed before any treatment launch: respectively on missing/disconnected labels, singleton transport coverage, and shallow breadth-first repair trees. Clean I002–I006 and all 12 R003 candidates passed at `adae81f` in jobs 55108–55113, retaining policy `e17a2551d54cc78678f6ca55c056e149f01d52b9081e0b2793d3eea2bea35ec2`; those records remain diagnostic because v3 changes the repair. Version v3 passes 15 focused geometry tests (job 55117) and an exact-cardinality/coverage audit of all 55 frozen topologies (job 55118). I010 GPU, R005–R014, and all confirmatory runs remain BLOCKED until their typed PASS records exist.
