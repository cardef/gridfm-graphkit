...
| I003 | M1 | Implement deterministic partition | Kron + Quotient | source topology only | stable-ID ordering, fixed METIS seed, connected-cardinality repair, anchor tie-break, permutation test | MUST | RUNNING | v2 passed its focused gate at `adae81f` (job 55109), but all-topology job 55114 exposed shallow tree splits; `metis-contiguous-covered-repair-v3` passes 15 focused tests (55117) and all 55 topology-only partition audits (55118), with final clean gate pending |
...
| R003 | M1 | Evaluate geometry candidates | Kron | source-development topology only | ≤12-policy table: residual, conditioning, nnz, FLOPs, build time, host peak | MUST | RUNNING | job 55113 authoritatively reran all 12 candidates at `adae81f` and retained policy hash `e17a2551d54cc78678f6ca55c056e149f01d52b9081e0b2793d3eea2bea35ec2`; v3 requires one final clean rerun before downstream freeze |
...
| Current Abacus backend | every PF pool is complete; full audit 55081, target freeze 55087, split freeze 55088, and materialization 55089 passed; diagnostic geometry jobs 55090, 55100, and 55114 failed closed; v3 focused tests 55117 and all-55 partition audit 55118 passed | all three geometry failures remain in the denominator; no target efficacy was read and no treatment launch is authorized |

1. **Geometry repair:** pass clean I002–I006 gates, rerun all 12 R003 candidates, and rebuild every frozen topology under `metis-contiguous-covered-repair-v3`.
