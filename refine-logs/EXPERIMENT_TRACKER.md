...
| Current Abacus backend | shared Python 3.12 environment validated on an RTX A4000 with NumPy 2.4.6, PyTorch 2.12.1+cu126, PyG 2.8.0, and PyMETIS 2025.2.2; independent documentation replay passed | accelerator access is usable; I002–I009 and R001/R002/R004 have formal PASS receipts at `93815a6`; spawn-before-Julia fix `1160cb0` clears the generation deadlock; G26 review, I010, R003, and later gates remain blocked; no treatment launch is authorized |

1. **Data generation:** jobs 54427 and 54428 generate the frozen static-topology pools (2,331 scenarios for each source; 512 for each source-development/target) from the R002-selected members; retry 54445 covers the task preempted before automatic requeue was enabled; dependent job 54446 audits all 55 outputs and runs R003 only after generation completes; target outcomes remain unreadable to selection code.
